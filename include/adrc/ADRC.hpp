...
public:
    void Init_ADRC(ADRC_Parameter param)
    {
        ...
        this->controller_param.omega = param.omega;
...
private:
    ...
    */
    ...
    void ESO_ADRC()
    {
        ...
        this->z2 = controller_param.h * (this->z3 - this->beta_02 * this->fe1 + controller_param.b0 * this->u);
        this->z3 +=controller_param.h * (-this->beta_03 * this->fe2);
        */
        this->z1 += controller_param.h * (this->z2 + this->beta_01 * this->e + controller_param.b0 * this->u);
        this->z2 += controller_param.h * (this->beta_02 * this->fe2);
    }
    ...
    */
    ...
    float ADRC_Control(float expect_ADRC, float feedback_ADRC)
    {
        ...
        this->u0 = controller_param.k_p * this->e1 + controller_param.k_d * this->e2;
